<template>
    ...
    <h1 id="pageName">Påmeldte aktiviteter</h1>
            ...
            axios
              ...
              .then((response) => {
                ...
                for (let i = 0; i < this.allActivities.length; i++) {
                  for (let j = 0; j < this.allActivities[i].participants.length; j++) {
                    if (this.allActivities[i].participants[j].user.id === utils.getUser().id) {
